...
using Lykke.Logs;
using Lykke.Service.BcnReports.Binders;
...
namespace Lykke.Service.BcnReports
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime appLifetime)
        {
            try
            {
                ...
                app.UseLykkeMiddleware("BcnReports", ex => new {Message = "Technical problem"});
        ...
        private static ILog CreateLogWithSlack(IServiceCollection services, IReloadingManager<GeneralSettings> settings)
        {
            ...
            var dbLogConnectionStringManager = settings.Nested(x => x.BcnReports.Db.LogsConnString);
            ...
            if (!string.IsNullOrEmpty(dbLogConnectionString) && !(dbLogConnectionString.StartsWith("${") && dbLogConnectionString.EndsWith("}")))
            {
                var persistenceManager = new LykkeLogToAzureStoragePersistenceManager(
                    AzureTableStorage<LogEntity>.Create(dbLogConnectionStringManager, "BcnReportsLog", consoleLogger),
                    consoleLogger);
